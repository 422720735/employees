...
<style lang="scss">
  ...
  @font-face {
    ...
    src: url(./assets/font/iconfont.eot?v=1.0.9);
    src: url(./assets/font/iconfont.eot?v=1.0.9#iefix) format('embedded-opentype'), url(./assets/font/iconfont.svg?v=1.0.9#iconfont) format('svg'), url(./assets/font/iconfont.woff?v=1.0.9) format('woff'), url(./assets/font/iconfont.ttf?v=1.0.9) format('truetype')
  }
